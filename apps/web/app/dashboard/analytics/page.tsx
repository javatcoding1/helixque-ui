      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
          ...
          <CardContent className="pl-2">
            <div className="h-[200px] w-full flex items-end justify-between gap-2 px-4">
                {ACTIVITY_DATA.map((value, i) => (
                    <div key={i} className="group relative w-full flex flex-col justify-end items-center gap-2">
                        <div 
        ...
        <Card className="col-span-3">
          ...
          <CardContent>
            ...
            <Button variant="outline" className="w-full mt-6">View All Visitors</Button>
          </CardContent>
        </Card>
      </div>
    </div>
