...
const generateMockChats = () => {
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    chats.push({
      ...
      timestamp: ["2 min ago", "1 hour ago", "3 hours ago", "Yesterday", "2 days ago"][Math.floor(Math.random() * 5)],
      messages: [
        { id: 1, sender: name, text: "Hey! How are you doing?", timestamp: "10:30 AM" },
        { id: 2, sender: "You", text: "I'm doing great! How about you?", timestamp: "10:32 AM" },
        { id: 3, sender: name, text: "That sounds great! When do you want to meet?", timestamp: "10:35 AM" },
        { id: 4, sender: "You", text: "How about this weekend?", timestamp: "10:37 AM" },
        { id: 5, sender: name, text: "This weekend works perfectly for me!", timestamp: "10:38 AM" },
        { id: 6, sender: "You", text: "Great! Let's meet at the coffee shop at 2 PM", timestamp: "10:40 AM" },
        { id: 7, sender: name, text: "Perfect! I'll see you there", timestamp: "10:41 AM" },
        { id: 8, sender: "You", text: "Can't wait! Should I bring anything?", timestamp: "10:42 AM" },
        { id: 9, sender: name, text: "No need, just bring yourself! 😊", timestamp: "10:43 AM" },
        { id: 10, sender: "You", text: "Sounds good. See you soon!", timestamp: "10:44 AM" },
        { id: 11, sender: name, text: "See you!", timestamp: "10:45 AM" },
        { id: 12, sender: "You", text: "Actually, do you like cappuccino or americano?", timestamp: "10:46 AM" },
        { id: 13, sender: name, text: "I prefer cappuccino with an extra shot", timestamp: "10:47 AM" },
        { id: 14, sender: "You", text: "Got it! I'll make sure to order that for you", timestamp: "10:48 AM" },
        { id: 15, sender: name, text: "You're amazing! Thank you", timestamp: "10:49 AM" },
        { id: 16, sender: "You", text: "My pleasure! See you at 2 PM", timestamp: "10:50 AM" },
        { id: 17, sender: name, text: "Looking forward to it!", timestamp: "10:51 AM" },
        { id: 18, sender: "You", text: "Me too! It's been a while since we caught up", timestamp: "10:52 AM" },
        { id: 19, sender: name, text: "I know right? We need to do this more often", timestamp: "10:53 AM" },
        { id: 20, sender: "You", text: "Absolutely! Let's make it a monthly thing", timestamp: "10:54 AM" },
      ],
    })
  }
  return chats
...
export default function ChatsPage() {
  ...
  return (
    <div className="flex h-[90vh] overflow-hidden bg-background gap-0 md:gap-4">
      {/* Chat List - Left Side */}
      <div className={`w-full md:w-80 flex flex-col bg-card overflow-hidden border-r transition-all duration-300 ${selectedChat ? 'hidden md:flex' : 'flex'}`}>
          ...
          {filteredChats.map((chat) => (
            ...
            >
              <Avatar className="h-8 w-8 md:h-10 md:w-10 flex-shrink-0">
                ...
                <AvatarFallback className="text-xs md:text-base">{chat.name.split(" ").map((n: string) => n[0]).join("")}</AvatarFallback>
              </Avatar>
      ...
      <div className={`flex flex-1 flex-col bg-card overflow-hidden border border-border transition-all duration-300 ${selectedChat ? 'flex' : 'hidden md:flex'}`}>
        {selectedChat ? (
          <>
            {/* Chat Header */}
            <div className="border-b p-3 md:p-4 flex items-center gap-2 md:gap-3 flex-shrink-0">
              ...
              <Avatar className="h-8 w-8 md:h-10 md:w-10">
                ...
                <AvatarFallback>{selectedChat.name.split(" ").map((n: string) => n[0]).join("")}</AvatarFallback>
              </Avatar>
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-xs md:text-sm truncate">{selectedChat.name}</h3>
