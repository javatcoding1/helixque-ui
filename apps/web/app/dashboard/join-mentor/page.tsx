...
const STEPS = [
  ...
  },
  {
    id: "expertise",
    title: "Expertise",
    description: "What can you help with?",
  },
...
export default function JoinMentorPage() {
      ...
      services: [
        {
          ...
          description: "30 min video call to discuss your career.",
          duration: "30 min",
          price: 0,
          currency: "USD",
        },
  ...
  const getFieldsForStep = (step: number) => {
    switch (step) {
      case 0:
        return ["headline", "about", "company", "role"];
      case 1:
        return ["expertise"];
      case 2:
        return ["services"];
                ...
                {currentStep === 0 && (
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        id="headline"
                        placeholder="Experienced Designer helping startups grow..."
                        {...register("headline")}
                      />
                      <p className="text-xs text-muted-foreground">
                        This will appear on your public mentor card.
                      </p>
                      {errors.headline && (
                        <p className="text-destructive text-sm">
                  ...
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div className="space-y-4">
                      {fields.map((field, index) => (
                        <div
                          key={field.id}
                          className="p-4 border border-border rounded-lg bg-card space-y-4 relative group"
                        >
                          <button
                            type="button"
                          ...
                          <div className="grid grid-cols-[2fr_1fr] gap-4">
                            ...
                            <div className="grid gap-2">
                              <Label>
                                Price ({watch(`services.${index}.currency`)})
                              </Label>
                              <Input
                                type="number"
