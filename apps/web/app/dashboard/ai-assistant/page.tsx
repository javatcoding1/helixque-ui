    ...
    setMessages([
      {
        ...
        role: "assistant",
        content:
          "Hello! I'm your Helixque AI Assistant. I can help you with code review, career advice, or finding the right mentor. How can I assist you today?",
        type: "text",
        timestamp: new Date(),
      },
    ]);
  ...
  const handleSendMessage = async (e?: React.FormEvent) => {
    ...
    setTimeout(() => {
      const newAiMsg: Message = {
        ...
        role: "assistant",
        content:
          "I'm analyzing your request... Here is a sample code snippet that might help you:",
        type: "text",
        timestamp: new Date(),
      };
          ...
          <div className="space-y-2">
            {[
              ...
              <Button
                key={i}
                variant="ghost"
                className="w-full justify-start text-sm font-normal text-muted-foreground hover:text-foreground hover:bg-muted/50 truncate"
              >
