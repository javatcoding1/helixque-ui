...
const MOCK_MENTOR_DETAILS: MentorDetails = {
  ...
  about:
    "I have over 10 years of experience in product design, working with top tier tech companies. I specialize in helping junior designers navigate their career paths, improve their portfolios, and prepare for interviews. My mentorship style is direct, actionable, and supportive.",
  expertise: [
    "UX Design",
    "Career Guidance",
    "Portfolio Review",
  ...
  services: [
    {
      ...
      price: 500,
      duration: "30 min",
      description: "Quick chat to discuss your career goals and blockers.",
    },
    {
      id: "s2",
      ...
      duration: "60 min",
      description:
        "Deep dive into your portfolio. I'll provide actionable feedback on 2-3 case studies.",
    },
    {
      id: "s3",
      ...
      price: 2000,
      duration: "60 min",
      description: "Real-world interview simulation with detailed feedback.",
    },
  ],
};
      ...
      <div className="flex-1 p-6 max-w-4xl mx-auto w-full space-y-8">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          <div className="relative shrink-0">
            ...
            <div
              className={`absolute bottom-1 right-1 h-5 w-5 rounded-full border-2 border-background ${mentor.status === "online" ? "bg-green-500" : "bg-gray-400"}`}
            />
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                ...
                <p className="text-muted-foreground flex items-center gap-2 mt-1">
                  <Briefcase className="h-4 w-4" /> {mentor.role} @{" "}
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              {mentor.expertise.map((tag) => (
                <Badge
                  key={tag}
                  variant="secondary"
                  className="bg-secondary/40 hover:bg-secondary/60 transition-colors cursor-default"
                >
                  {tag}
                </Badge>
              ))}
            ...
            <Card className="bg-muted/30 border-none shadow-none">
              <CardHeader>
                <CardTitle className="text-base flex items-center gap-2">
                  <ShieldCheck className="h-5 w-5 text-green-600" /> Verified
                  Mentor
                </CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-muted-foreground space-y-4">
                <p>
                  This mentor has been verified by the Helixque team for their
        ...
        <Dialog open={isPaymentOpen} onOpenChange={setIsPaymentOpen}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                You are booking <strong>{selectedService?.title}</strong> for{" "}
              ...
              <div className="p-4 bg-muted/50 rounded-lg space-y-3">
                ...
                <div className="flex justify-between text-sm text-muted-foreground">
                  ...
                  <span>
                    ₹
                    {selectedService
                      ? Math.round(selectedService.price * 0.02)
                      : 0}
                  </span>
                </div>
                <Separator />
            ...
            <DialogFooter>
              ...
              <Button onClick={handlePayment} disabled={isProcessing}>
                {isProcessing
                  ? "Processing..."
                  : `Pay ₹${selectedService ? selectedService.price + Math.round(selectedService.price * 0.02) : 0}`}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
