            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-3">
                ...
                <Combobox
                  ...
                  onChange={(val) =>
                    form.setValue("role", val as any, { shouldValidate: true })
                  }
              ...
              <div className="space-y-3">
                ...
                <Combobox
                  ...
                  onChange={(val) =>
                    form.setValue("domain", val as any, {
                      shouldValidate: true,
                    })
                  }
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-3">
                ...
                <Combobox
                  ...
                  onChange={(val) =>
                    form.setValue("techStack", val as any, {
                      shouldValidate: true,
                    })
                  }
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-3">
                ...
                <Combobox
                  ...
                  onChange={(val) =>
                    form.setValue("languages", val as any, {
                      shouldValidate: true,
                    })
                  }
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-3">
                ...
                <Combobox
                  ...
                  onChange={(val) =>
                    form.setValue("experience", val as any, {
                      shouldValidate: true,
                    })
                  }
