    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <div className="flex flex-col gap-2 text-center items-center">
        <div className="flex size-12 items-center justify-center rounded-lg bg-primary/10 mb-2">
           <img src="https://www.helixque.com/logo.svg" alt="Helixque Logo" className="size-8" />
        </div>
        <h1 className="text-2xl font-bold tracking-tight">Create an account</h1>
        <p className="text-muted-foreground text-sm">
          Create your account securely with LinkedIn
        </p>
      </div>
      <div className="grid gap-4">
        <Button variant="default" className="w-full h-11" onClick={() => signIn("linkedin", { callbackUrl: "/dashboard" })}>
            <svg
