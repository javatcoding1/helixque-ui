...
export default function PreferenceSelector({ onJoin }: PreferenceSelectorProps) {
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4 [scrollbar-width:thin]">
            <form id="preference-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                {/* Domain */}
                <div className="space-y-2">
                    <Label>Target Domain <span className="text-red-500">*</span></Label>
                    <Combobox
                        options={DOMAINS}
                    ...
                    />
                     {form.formState.errors.domain && (
                        <p className="text-xs text-red-500">{form.formState.errors.domain.message}</p>
                    )}
                </div>
                ...
                <div className="space-y-2">
                    ...
                    {form.formState.errors.techStack && (
                        <p className="text-xs text-red-500">{form.formState.errors.techStack.message}</p>
                    )}
                </div>

                {/* Experience */}
                <div className="space-y-2">
                    <Label>Minimum Experience <span className="text-red-500">*</span></Label>
                    <Combobox
                    ...
                    {form.formState.errors.minExperience && (
                        <p className="text-xs text-red-500">{form.formState.errors.minExperience.message}</p>
                    )}
                </div>
            </form>
        </div>
