    ...
    return (
      <div className="flex h-full flex-col gap-4">
        <div className="flex justify-center gap-4">
          <div className="relative aspect-video w-64 overflow-hidden rounded-2xl border border-white/10 bg-black shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
            <video
              ref={localVideoRef}
              autoPlay
              playsInline
          ...
          <div className="relative aspect-video w-64 overflow-hidden rounded-2xl border border-white/10 bg-black shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
            ...
            <div className="absolute bottom-2 left-2 flex items-center gap-1 rounded-md bg-black/60 px-2 py-1 text-xs">
              <span>Peer</span>
              {!peerMicOn && <IconMicrophoneOff className="h-3 w-3" />}
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          <div className="absolute bottom-3 left-3 flex items-center gap-2 rounded-md bg-black/60 px-2 py-1 text-xs">
            ...
            {!lobby && !peerMicOn && (
              <span className="inline-flex items-center gap-1 rounded bg-red-600/80 px-1.5 py-0.5">
                <IconMicrophoneOff className="h-3 w-3" />
                <span>muted</span>
              </span>
            )}
            {peerScreenShareOn && (
              <span className="inline-flex items-center gap-1 rounded bg-blue-600/80 px-1.5 py-0.5">
